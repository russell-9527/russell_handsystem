...
class Claw:
    ...
    def __init__(self):
        ...
        self.canMsg =can.Message(arbitration_id=0, data=[0, 0, 0, 0, 0, 0, 0, 0], is_extended_id=8)
    ...
    def canbuson(self):
        ...
        self.ch = can.interface.Bus(channel='can0', interface='socketcan')
    ...
    def readCanBlocking(self):
        ...
        try:
            ...
            self.canMsg = self.ch.recv(timeout=10)

            self.canData = tuple(self.canMsg.data)
            print(self.canMsg)
        except self.ch.recv(timeout=0) is None:
    ...
    def ConnectCheck(self):
        ...
        if timePass > 10:
            ...
            self.ch.send(
                can.Message(
                    arbitration_id=CanId.CANID_PI_TO_ALL,
    ...
    def Initialization(self):
        ...
        if self.sendFirstTimeFlag[Device.UNO]:
            ...
            self.ch.send(
                can.Message(
                    arbitration_id=CanId.CANID_PI_TO_UNO,
        ...
        if self.sendFirstTimeFlag[Device.STM]:
            ...
            self.ch.send(
                can.Message(
                    arbitration_id=CanId.CANID_PI_TO_STM,

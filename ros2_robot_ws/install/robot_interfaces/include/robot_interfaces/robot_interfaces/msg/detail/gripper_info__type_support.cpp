...
{
  new (message_memory) robot_interfaces::msg::GripperInfo(_init);
}

void GripperInfo_fini_function(void * message_memory)
{
  auto typed_message = static_cast<robot_interfaces::msg::GripperInfo *>(message_memory);
  typed_message->~GripperInfo();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember GripperInfo_message_member_array[1] = {
  {
    "result",  // name
    ...
    offsetof(robot_interfaces::msg::GripperInfo, result),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GripperInfo_message_members = {
  ...
  1,  // number of fields
  sizeof(robot_interfaces::msg::GripperInfo),
...
get_message_type_support_handle<robot_interfaces::msg::GripperInfo>()
{
  return &::robot_interfaces::msg::rosidl_typesupport_introspection_cpp::GripperInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robot_interfaces, msg, GripperInfo)() {
  return &::robot_interfaces::msg::rosidl_typesupport_introspection_cpp::GripperInfo_message_type_support_handle;
}

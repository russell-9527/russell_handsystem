...
#include "robot_interfaces/msg/detail/gripper_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robot_interfaces::msg::GripperCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robot_interfaces::msg::GripperCommand & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
...
{
  auto typed_message =
    static_cast<const robot_interfaces::msg::GripperCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robot_interfaces::msg::GripperCommand *>(
    untyped_ros_message);
...
{
  return &robot_interfaces::msg::typesupport_fastrtps_cpp::_GripperCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_interfaces, msg, GripperCommand)() {
  return &robot_interfaces::msg::typesupport_fastrtps_cpp::_GripperCommand__handle;
}
